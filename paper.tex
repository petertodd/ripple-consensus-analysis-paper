...
\begin{enumerate}
    ...
    \item Reviewed whitepapers and development documentation at \url{https://ripple.com}.
...
amount of XRP is irrovocably destroyed for every transaction.} and to
...
or at least it's use minimized, many of these issues may go away.
